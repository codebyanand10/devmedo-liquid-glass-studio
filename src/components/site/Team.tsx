...
const developers: Developer[] = [
  {
    ...
    badges: ["Web & Mobile Apps", "React / Next.js / Flutter", "Cloud & Business Automation"],
  },
];
  ...
  return (
    <section id="team" className="relative bg-white text-black py-20 px-6 sm:px-10 border-t border-zinc-200">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Developer Card (Single Centered) */}
        <div className="max-w-md mx-auto">
          {developers.map((dev, idx) => (
            <div
              key={dev.name}
              className="bg-white rounded-3xl p-6 sm:p-8 border border-zinc-200 shadow-sm hover:shadow-2xl hover:border-purple-300 transition-all duration-300 text-center flex flex-col justify-between group"
            >
              <div>
                ...
                <div className="w-full h-64 sm:h-72 rounded-2xl bg-[#0f0a1a] overflow-hidden mb-6 relative flex items-center justify-center p-4 border border-purple-900/20 shadow-inner">
                  {/* Monochromatic code/terminal texture */}
                  <div className="w-full h-full rounded-xl bg-gradient-to-b from-[#140d24] to-[#08050e] p-4 font-mono text-[10px] text-zinc-400 text-left overflow-hidden flex flex-col justify-between opacity-90 group-hover:opacity-100 transition-opacity">
                    <div className="space-y-1">
                      <div className="flex items-center gap-1.5 pb-2 border-b border-purple-900/40">
                        ...
                        <span className="text-purple-300 font-bold uppercase">anand_core.tsx</span>
                      </div>
                      <p className="text-zinc-500">// Production Ready Software Studio Architecture</p>
                      <p className="text-[#c084fc]">import &#123; createEngine, deploySystem &#125; from "@devmedo/core";</p>
                      <p className="text-purple-200">export async function launchProject() &#123;</p>
                      <p className="text-zinc-400 pl-2">const engine = await createEngine(&#123;</p>
                      <p className="text-zinc-400 pl-4">lead: "Anand.A.B",</p>
                      <p className="text-zinc-400 pl-4">performance: "ultra-fast",</p>
                      <p className="text-zinc-400 pl-4">automation: "enabled",</p>
                    ...
                    <div className="flex justify-between items-center text-[9px] text-zinc-500 pt-2 border-t border-purple-900/30">
                      ...
                      <span className="text-[#a855f7] font-bold">VERIFIED LEAD</span>
                    </div>
                  </div>
                </div>

                {/* Developer Info */}
                <h3 className="font-display font-black text-2xl sm:text-3xl uppercase tracking-tight text-black group-hover:text-[#9333ea] transition-colors">
                  {dev.name}
                </h3>
                <p className="text-xs font-bold text-[#9333ea] mt-1 mb-6">
                  {dev.role}
                </p>
              </div>
